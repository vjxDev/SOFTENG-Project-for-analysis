...
(define /%const__merge_calls_in_system__2 (@Make 110 '() (list (@Make 6 '() (list (@Make 506 -1 '()) (@Make 217 -2 '()))))))
;
;==========================================================================
 ...
 (let ((/n-save /n)
  ...
  (cond
   ...
   ((> (@Struct_Metric (@I)) (+ /struct 50))
    (display-list "Struct_Metric has increased too much!")
    (@Paste_Over /orig)))
  (set! /n /n-save)
  (set! //Z //Z-save)
    ...
    (while (= /fl_flag1 0) 
     (cond
      ...
      (#t
       (@Right)
       (let ((/__/O/K 1))
        (set! /__/O/K (@New_Match  /%const__merge_calls_in_system__2 (@I) /__/O/K))
        (cond
         ((= /__/O/K 1)
          (let ((/__e_save /e)
                (/__v_save /v))
