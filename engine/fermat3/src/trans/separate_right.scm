  ...
  (cond
   ((and (or (= //Type //T_/Cond) (= //Type //T_/D_/If)) (<= (@Size (@I)) //Max_/Cond_/Size))
    ...
    (cond
     ((@Failed?)
      (cond
       ((null? (@Last_Non_Comment (@Cs (@Get_n (@Get_n (@I) 1) 2))))
        #t)
       ((and (= (@Size (@I)) 2) (@Equal? (@Last_Non_Comment (@Cs (@Get_n (@Get_n (@I) 1) 2))) (@Last_Non_Comment (@Cs (@Get_n (@Get_n (@I) 2) 2)))))
        (@Pass))
       ((and (= (@Size (@I)) 3) (@Equal? (@Last_Non_Comment (@Cs (@Get_n (@Get_n (@I) 1) 2))) (@Last_Non_Comment (@Cs (@Get_n (@Get_n (@I) 2) 2)))) (@Equal? (@Last_Non_Comment (@Cs (@Get_n (@Get_n (@I) 1) 2))) (@Last_Non_Comment (@Cs (@Get_n (@Get_n (@I) 3) 2)))))
        (@Pass))))))
   ((= //Type //T_/Where)
    (@Down)
    (@Down_Last)
      ...
      ((= //O/K 1)
       ...
       (for //J 1 (@Size (@I)) 1 
        (begin
         ...
         (@Up)
         (@Up))))
      ((or (and (= (@Size (@I)) 2) (@Equal? (@Last_Non_Comment (@Cs (@Get_n (@Get_n (@I) 1) 2))) (@Last_Non_Comment (@Cs (@Get_n (@Get_n (@I) 2) 2))))) (and (= (@Size (@I)) 3) (@Equal? (@Last_Non_Comment (@Cs (@Get_n (@Get_n (@I) 1) 2))) (@Last_Non_Comment (@Cs (@Get_n (@Get_n (@I) 2) 2)))) (@Equal? (@Last_Non_Comment (@Cs (@Get_n (@Get_n (@I) 1) 2))) (@Last_Non_Comment (@Cs (@Get_n (@Get_n (@I) 3) 2))))))
       (let ((/save '()))
        (@Down)
        (@Down_Last)
        (@Down_Last)
        ; to last statement, first guarded 
        (set! /fl_flag1 0)
        (while (= /fl_flag1 0) 
         (begin
