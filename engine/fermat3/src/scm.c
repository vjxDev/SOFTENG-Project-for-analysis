...
init_rand_dot_scx();
init_string_dot_scx();
init_support_dot_scx();
init_adt_dot_scx();
init_adt2_dot_scx();
init_names_dot_scx();
init_wsl_init_dot_scx();
init_adt_edit_dot_scx();
init_adt_loops_dot_scx();
init_adt_procs_dot_scx();
init_extra_dot_scx();
init_invert_dot_scx();
init_match_dot_scx();
init_maths_dot_scx();
init_maths2_2_dot_scx();
init_metrics_dot_scx();
init_query_dot_scx();
init_random_program_dot_scx();
init_tr_engine_dot_scx();
init_utility_dot_scx();
init_wp_dot_scx();
init_abort_processing_dot_scx();
init_absorb_left_dot_scx();
init_absorb_right_dot_scx();
init_actions_to_procs_dot_scx();
init_actions_to_where_dot_scx();
init_add_assertion_dot_scx();
init_add_left_dot_scx();
init_add_loop_to_action_dot_scx();
init_align_nested_statements_dot_scx();
init_align_nested_vars_dot_scx();
init_all_proc_stacks_to_pars_dot_scx();
init_all_push_pop_dot_scx();
init_apply_to_right_dot_scx();
init_array_to_vars_dot_scx();
init_collapse_action_system_dot_scx();
init_collapse_all_systems_dot_scx();
init_combine_wheres_dot_scx();
init_constant_propagation_dot_scx();
init_d_do_to_floop_dot_scx();
init_decrement_statement_dot_scx();
init_delete_all_assertions_dot_scx();
init_delete_all_comments_dot_scx();
init_delete_all_redundant_dot_scx();
init_delete_all_skips_dot_scx();
init_delete_item_dot_scx();
init_delete_redundant_regs_dot_scx();
init_delete_redundant_statement_dot_scx();
init_delete_unreachable_code_dot_scx();
init_delete_what_follows_dot_scx();
init_double_to_single_loop_dot_scx();
init_else_if_to_elsif_dot_scx();
init_elsif_to_else_if_dot_scx();
init_expand_and_separate_dot_scx();
init_expand_and_separate_all_dot_scx();
init_expand_call_dot_scx();
init_expand_forward_dot_scx();
init_find_terminals_dot_scx();
init_flag_removal_dot_scx();
init_floop_to_while_dot_scx();
init_for_in_to_reduce_dot_scx();
init_for_to_while_dot_scx();
init_force_double_to_single_loop_dot_scx();
init_fully_absorb_right_dot_scx();
init_fully_expand_forward_dot_scx();
init_globalise_procs_dot_scx();
init_globals_to_pars_dot_scx();
init_ifmatch_processing_dot_scx();
init_increment_statement_dot_scx();
init_insert_assertion_dot_scx();
init_join_all_cases_dot_scx();
init_join_cases_left_dot_scx();
init_join_cases_right_dot_scx();
init_localise_procs_dot_scx();
init_loop_doubling_dot_scx();
init_loop_inversion_dot_scx();
init_loop_to_move_dot_scx();
init_make_loop_dot_scx();
init_make_proc_dot_scx();
init_make_reducible_dot_scx();
init_merge_calls_in_action_dot_scx();
init_merge_calls_in_system_dot_scx();
init_merge_cond_right_dot_scx();
init_merge_left_dot_scx();
init_merge_right_dot_scx();
init_meta_trans_dot_scx();
init_move_comment_left_dot_scx();
init_move_comment_right_dot_scx();
init_move_comments_dot_scx();
init_move_to_left_dot_scx();
init_move_to_right_dot_scx();
init_partially_join_cases_dot_scx();
init_proc_to_funct_dot_scx();
init_prog_to_spec_dot_scx();
init_prune_dispatch_dot_scx();
init_push_pop_dot_scx();
init_recursion_to_loop_dot_scx();
init_reduce_loop_dot_scx();
init_reduce_multiple_loops_dot_scx();
init_refine_spec_dot_scx();
init_remove_all_redundant_vars_dot_scx();
init_remove_dummy_loop_dot_scx();
init_remove_redundant_vars_dot_scx();
init_rename_defns_dot_scx();
init_rename_local_vars_dot_scx();
init_rename_proc_dot_scx();
init_replace_accs_with_value_dot_scx();
init_replace_with_value_dot_scx();
init_replace_with_variable_dot_scx();
init_restore_local_vars_dot_scx();
init_reverse_order_dot_scx();
init_roll_loop_dot_scx();
init_semantic_slice_dot_scx();
init_separate_both_dot_scx();
init_separate_exit_code_dot_scx();
init_separate_left_dot_scx();
init_separate_right_dot_scx();
init_simple_slice_dot_scx();
init_simplify_dot_scx();
init_simplify_action_system_dot_scx();
init_simplify_if_dot_scx();
init_simplify_item_dot_scx();
init_sort_procs_dot_scx();
init_stack_to_par_dot_scx();
init_stack_to_return_dot_scx();
init_stack_to_var_dot_scx();
init_static_single_assignment_dot_scx();
init_substitute_and_delete_dot_scx();
init_substitute_and_delete_list_dot_scx();
init_syntactic_slice_dot_scx();
init_take_out_left_dot_scx();
init_take_out_of_loop_dot_scx();
init_take_out_right_dot_scx();
init_unfold_proc_call_dot_scx();
init_unfold_proc_calls_dot_scx();
init_unroll_loop_dot_scx();
init_use_assertion_dot_scx();
init_var_pars_to_val_pars_dot_scx();
init_while_to_abort_dot_scx();
init_while_to_floop_dot_scx();
init_while_to_for_in_dot_scx();
init_while_to_reduce_dot_scx();
init_ssa_dot_scx();
init_blocks_dot_scx();
init_cond_parser_dot_scx();
init_exp_parser_dot_scx();
init_flowchart_dot_scx();
init_lexer_dot_scx();
init_parser_dot_scx();
init_summ_dot_scx();
init_summ2_dot_scx();
init_wsl2scheme_dot_scx();
init_wsl2wsl_dot_scx();
